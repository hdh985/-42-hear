...
{`🎯 [HEART SHOT] 이용약관 (축제 부스 웹 주문 서비스)
본 이용약관은 외국어대학 학생회(HEART SHOT) 부스(이하 '운영자')가 제공하는 주문/결제 서비스(이하 '서비스')의 이용조건 및 절차, 운영자와 이용자의 권리·의무·책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
